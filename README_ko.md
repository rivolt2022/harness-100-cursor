...
일상생활과 업무에 바로 적용할 수 있는 **102가지 에이전트 팀 하네스**를 구축한 프로젝트입니다.
...
## 카테고리 12: 브라우저 익스텐션 (102)

| # | 하네스 | 설명 | 에이전트 |
|---|--------|------|---------|
| 102 | [chrome-extension](102-chrome-extension/) | MV3 크롬 익스텐션: 아키텍처→background→UI→content→보안·스토어 | 5명 |

...
|-------|------|------|------|
| architect | `.cursor/agents/architect.md` | Requirements, architecture, DB, API design | general-purpose |
| frontend-dev | `.cursor/agents/frontend-dev.md` | React/Next.js frontend implementation | general-purpose |
| backend-dev | `.cursor/agents/backend-dev.md` | API, DB, auth, business logic | general-purpose |
| qa-engineer | `.cursor/agents/qa-engineer.md` | Test strategy, test code, code review | general-purpose |
| devops-engineer | `.cursor/agents/devops-engineer.md` | CI/CD, infrastructure, deployment, monitoring | general-purpose |
...
| Message-based | Task tool calls to subagents | API integration issues, code review, fix requests |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| curriculum-designer | `.cursor/agents/curriculum-designer.md` | 학습목표, 커리큘럼 구조 설계 | general-purpose |
| content-writer | `.cursor/agents/content-writer.md` | 교안, 슬라이드, 강사노트 | general-purpose |
| quiz-maker | `.cursor/agents/quiz-maker.md` | 형성평가, 총괄평가, 피드백 | general-purpose |
| lab-designer | `.cursor/agents/lab-designer.md` | 실습과제, 프로젝트, 루브릭 | general-purpose |
| course-reviewer | `.cursor/agents/course-reviewer.md` | 학습목표 정렬, 커버리지 검증 | general-purpose |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| storyteller | `.cursor/agents/storyteller.md` | 메시지 구조화, 논리 흐름 설계 | general-purpose |
| info-architect | `.cursor/agents/info-architect.md` | 데이터 시각화, 정보 계층 설계 | general-purpose |
| visual-designer | `.cursor/agents/visual-designer.md` | 슬라이드 레이아웃, 디자인 시스템 | general-purpose |
| presentation-coach | `.cursor/agents/presentation-coach.md` | 발표 노트, 타이밍, Q&A 준비 | general-purpose |
| deck-reviewer | `.cursor/agents/deck-reviewer.md` | 교차 검증, 정합성 확인 | general-purpose |

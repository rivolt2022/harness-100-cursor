...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| translator | `.cursor/agents/translator.md` | 원문 분석, 1차 번역 | general-purpose |
| localizer | `.cursor/agents/localizer.md` | 문화 적응, 형식 현지화 | general-purpose |
| terminology-manager | `.cursor/agents/terminology-manager.md` | 용어집 구축, 일관성 관리 | general-purpose |
| style-harmonizer | `.cursor/agents/style-harmonizer.md` | 톤앤보이스 통일, 문체 조정 | general-purpose |
| quality-reviewer | `.cursor/agents/quality-reviewer.md` | MQM 기반 품질 검증 | general-purpose |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| story-architect | `.cursor/agents/story-architect.md` | 내러티브 구조, 장면 설계 | general-purpose |
| essay-writer | `.cursor/agents/essay-writer.md` | 본문, 캡션, 인용구 집필 | general-purpose |
| image-prompter | `.cursor/agents/image-prompter.md` | Gemini 이미지 프롬프트, 생성 | general-purpose |
| layout-builder | `.cursor/agents/layout-builder.md` | HTML/CSS 레이아웃 제작 | general-purpose |
| editorial-reviewer | `.cursor/agents/editorial-reviewer.md` | 교차 검증, 정합성 확인 | general-purpose |

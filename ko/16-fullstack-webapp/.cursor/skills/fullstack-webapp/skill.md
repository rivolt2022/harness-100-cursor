...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| architect | `.cursor/agents/architect.md` | 요구사항, 아키텍처, DB, API 설계 | general-purpose |
| frontend-dev | `.cursor/agents/frontend-dev.md` | React/Next.js 프론트엔드 구현 | general-purpose |
| backend-dev | `.cursor/agents/backend-dev.md` | API, DB, 인증, 비즈니스 로직 | general-purpose |
| qa-engineer | `.cursor/agents/qa-engineer.md` | 테스트 전략, 테스트 코드, 코드 리뷰 | general-purpose |
| devops-engineer | `.cursor/agents/devops-engineer.md` | CI/CD, 인프라, 배포, 모니터링 | general-purpose |
...
| 메시지 기반 | Task 툴로 Subagent 호출 | API 연동 이슈, 코드 리뷰, 수정 요청 |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| ux-designer | `.cursor/agents/ux-designer.md` | UX/UI 설계, 와이어프레임, 디자인 시스템 | general-purpose |
| app-developer | `.cursor/agents/app-developer.md` | 네이티브/크로스플랫폼 앱 코드 생성 | general-purpose |
| api-integrator | `.cursor/agents/api-integrator.md` | API 클라이언트, 인증, 캐싱 | general-purpose |
| store-manager | `.cursor/agents/store-manager.md` | 스토어 메타데이터, ASO, 심사 대응 | general-purpose |
| qa-engineer | `.cursor/agents/qa-engineer.md` | 품질 검증, 교차 정합성 확인 | general-purpose |

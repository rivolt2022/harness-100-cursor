...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| data-modeler | `.cursor/agents/data-modeler.md` | ERD, 정규화, 관계 설계 | general-purpose |
| migration-manager | `.cursor/agents/migration-manager.md` | DDL, 버전관리, 롤백 | general-purpose |
| performance-analyst | `.cursor/agents/performance-analyst.md` | 인덱싱, 쿼리 최적화 | general-purpose |
| security-auditor | `.cursor/agents/security-auditor.md` | 접근 제어, 암호화, 감사 | general-purpose |
| integration-reviewer | `.cursor/agents/integration-reviewer.md` | 정합성, 운영 준비성 검증 | general-purpose |

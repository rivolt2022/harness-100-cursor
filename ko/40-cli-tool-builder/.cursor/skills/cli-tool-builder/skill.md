...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| command-designer | `.cursor/agents/command-designer.md` | 명령 체계 설계 | general-purpose |
| core-developer | `.cursor/agents/core-developer.md` | 코어 구현 | general-purpose |
| test-engineer | `.cursor/agents/test-engineer.md` | 테스트 작성 | general-purpose |
| docs-writer | `.cursor/agents/docs-writer.md` | 문서 작성 | general-purpose |
| release-engineer | `.cursor/agents/release-engineer.md` | 빌드, 배포 | general-purpose |
...
| 메시지 기반 | Task 툴로 Subagent 호출 | 실시간 핵심 정보 전달, 버그 리포트 |
...
| 스킬 | 파일 | 대상 에이전트 | 역할 |
|------|------|-------------|------|
| arg-parser-generator | `.cursor/skills/arg-parser-generator/skill.md` | command-designer, core-developer | 인자 유형 분류, 서브커맨드 패턴, 언어별 파서 보일러플레이트, 도움말 표준 |
| ux-linter | `.cursor/skills/ux-linter/skill.md` | test-engineer, docs-writer | CLI UX 12원칙, 에러 메시지 표준, 출력 포맷 가이드, 색상/인터랙션 패턴 |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| trend-analyst | `.cursor/agents/trend-analyst.md` | 출제경향 분석, 빈출영역 도출 | general-purpose |
| diagnostician | `.cursor/agents/diagnostician.md` | 약점 진단, 취약점 식별 | general-purpose |
| learning-designer | `.cursor/agents/learning-designer.md` | 맞춤학습 설계, 자료 구성 | general-purpose |
| examiner | `.cursor/agents/examiner.md` | 모의고사 출제, 해설 작성 | general-purpose |
| error-analyst | `.cursor/agents/error-analyst.md` | 오답 분석, 보완 전략 수립 | general-purpose |
...
| 메시지 기반 | Task 툴로 Subagent 호출 | 실시간 핵심 정보 전달, 보완 요청 |

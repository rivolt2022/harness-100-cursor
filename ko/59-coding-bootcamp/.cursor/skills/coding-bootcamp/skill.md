...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| curriculum-designer | `.cursor/agents/curriculum-designer.md` | 커리큘럼 설계, 기술 스택 선정 | general-purpose |
| exercise-creator | `.cursor/agents/exercise-creator.md` | 실습 과제 출제, 테스트케이스 | general-purpose |
| code-reviewer | `.cursor/agents/code-reviewer.md` | 코드 리뷰, 품질 피드백 | general-purpose |
| mentor | `.cursor/agents/mentor.md` | 프로젝트 설계, 포트폴리오, 커리어 | general-purpose |

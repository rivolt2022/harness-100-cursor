...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| law-mapper | `.cursor/agents/law-mapper.md` | 법규 식별, 조항 매핑, 의무사항 추출 | general-purpose |
| status-auditor | `.cursor/agents/status-auditor.md` | 현황 조사, 증거 수집, 이행 평가 | general-purpose |
| gap-analyst | `.cursor/agents/gap-analyst.md` | 갭 식별, 리스크 산정, 우선순위 도출 | general-purpose |
| remediation-planner | `.cursor/agents/remediation-planner.md` | 시정 조치, 일정 수립, 모니터링 체계 | general-purpose |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| case-searcher | `.cursor/agents/case-searcher.md` | 판례 검색, 동향 분석 | general-purpose |
| legal-analyst | `.cursor/agents/legal-analyst.md` | 쟁점 도출, 법리 분석 | general-purpose |
| opinion-writer | `.cursor/agents/opinion-writer.md` | 법률 의견서 작성 | general-purpose |
| strategy-advisor | `.cursor/agents/strategy-advisor.md` | 전략 수립, 리스크 평가 | general-purpose |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| nutritionist | `.cursor/agents/nutritionist.md` | 영양 분석, 칼로리·매크로 목표 설정 | general-purpose |
| meal-designer | `.cursor/agents/meal-designer.md` | 일간/주간 식단표 설계 | general-purpose |
| recipe-writer | `.cursor/agents/recipe-writer.md` | 상세 레시피, 영양정보, 대체재료 | general-purpose |
| shopping-coordinator | `.cursor/agents/shopping-coordinator.md` | 장보기 목록, 조리 가이드, 밀프렙 | general-purpose |

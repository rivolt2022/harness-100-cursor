...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| program-architect | `.cursor/agents/program-architect.md` | 프로그램 설계, 주기화, 스케줄 | general-purpose |
| exercise-guide | `.cursor/agents/exercise-guide.md` | 운동 동작 설명, 폼 가이드, 대체운동 | general-purpose |
| nutrition-linker | `.cursor/agents/nutrition-linker.md` | 운동별 영양전략, 보충제, 타이밍 | general-purpose |
| template-builder | `.cursor/agents/template-builder.md` | 기록지, 추적표, 평가 양식 | general-purpose |

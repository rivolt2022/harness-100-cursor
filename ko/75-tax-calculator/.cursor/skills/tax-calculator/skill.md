...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| income-analyst | `.cursor/agents/income-analyst.md` | 소득 분류, 과세표준 산출 | general-purpose |
| deduction-optimizer | `.cursor/agents/deduction-optimizer.md` | 소득공제·세액공제 최적화 | general-purpose |
| tax-engine | `.cursor/agents/tax-engine.md` | 세액 계산, 납부/환급 산출 | general-purpose |
| strategy-advisor | `.cursor/agents/strategy-advisor.md` | 절세 시뮬레이션, 신고 준비 | general-purpose |

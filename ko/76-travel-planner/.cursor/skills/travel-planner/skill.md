...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| destination-analyst | `.cursor/agents/destination-analyst.md` | 목적지 리서치, 관광지, 안전정보 | general-purpose |
| itinerary-designer | `.cursor/agents/itinerary-designer.md` | 일별 일정, 동선 최적화, 숙소 | general-purpose |
| budget-manager | `.cursor/agents/budget-manager.md` | 예산 산출, 비용 비교, 절약 팁 | general-purpose |
| local-guide | `.cursor/agents/local-guide.md` | 교통, 맛집, 문화, 긴급 정보 | general-purpose |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| style-analyst | `.cursor/agents/style-analyst.md` | 공간 파악, 스타일 진단, 레퍼런스 수집 | general-purpose |
| moodboard-designer | `.cursor/agents/moodboard-designer.md` | 컬러팔레트, 텍스처, 소재 구성 | general-purpose |
| item-curator | `.cursor/agents/item-curator.md` | 가구·소품 선정, 배치 제안, 구매처 조사 | general-purpose |
| budget-manager | `.cursor/agents/budget-manager.md` | 가격 조사, 예산표, 쇼핑가이드 | general-purpose |
| concept-reviewer | `.cursor/agents/concept-reviewer.md` | 교차 검증, 정합성 확인 | general-purpose |

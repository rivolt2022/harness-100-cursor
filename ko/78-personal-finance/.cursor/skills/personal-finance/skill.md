...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| financial-analyst | `.cursor/agents/financial-analyst.md` | 수입지출 분석, 재무건전성 진단 | general-purpose |
| budget-planner | `.cursor/agents/budget-planner.md` | 예산 설계, 저축 계획 | general-purpose |
| investment-advisor | `.cursor/agents/investment-advisor.md` | 자산배분, 포트폴리오 설계 | general-purpose |
| tax-strategist | `.cursor/agents/tax-strategist.md` | 절세 전략, 은퇴 설계 | general-purpose |
| finance-reviewer | `.cursor/agents/finance-reviewer.md` | 교차 검증, 수치 정합성 확인 | general-purpose |

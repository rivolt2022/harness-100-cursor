...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| timeline-designer | `.cursor/agents/timeline-designer.md` | D-day 역산, 월별 일정 | general-purpose |
| budget-controller | `.cursor/agents/budget-controller.md` | 예산 배분, 비용 절감 | general-purpose |
| vendor-analyst | `.cursor/agents/vendor-analyst.md` | 업체 조사, 비교표 | general-purpose |
| checklist-builder | `.cursor/agents/checklist-builder.md` | 체크리스트, 청첩장 문구 | general-purpose |
| wedding-reviewer | `.cursor/agents/wedding-reviewer.md` | 교차 검증, 정합성 확인 | general-purpose |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| audience-analyst | `.cursor/agents/audience-analyst.md` | 청중 프로파일, 감정 여정, 메시지 프레이밍 | general-purpose |
| speech-writer | `.cursor/agents/speech-writer.md` | 연설문/발표 대본, 수사학, 무대 지시 | general-purpose |
| debate-preparer | `.cursor/agents/debate-preparer.md` | 논증 강화, 반론 방어, 교차심문 | general-purpose |
| qa-strategist | `.cursor/agents/qa-strategist.md` | 예상 질문, 답변 전략, Q&A 운영 | general-purpose |
| rehearsal-coach | `.cursor/agents/rehearsal-coach.md` | 리허설 계획, 전달력, 교차 검증 | general-purpose |
...
| 확장 스킬 | 경로 | 대상 에이전트 | 역할 |
|----------|------|-------------|------|
| rhetoric-patterns | `.cursor/skills/rhetoric-patterns/skill.md` | speech-writer, debate-preparer | 수사학 패턴, 논증 구조, 설득 기법 |
| audience-engagement | `.cursor/skills/audience-engagement/skill.md` | audience-analyst, rehearsal-coach | 청중 분석, 참여 전략, 긴장 관리, 비언어 커뮤니케이션 |

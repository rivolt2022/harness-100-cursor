...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| concept-planner | `.cursor/agents/concept-planner.md` | 컨셉, 목표, 타깃, 예산 | general-purpose |
| logistics-manager | `.cursor/agents/logistics-manager.md` | 장소, 동선, 장비, 안전 | general-purpose |
| program-designer | `.cursor/agents/program-designer.md` | 타임테이블, 세션, 연사 | general-purpose |
| promotion-lead | `.cursor/agents/promotion-lead.md` | 채널전략, 홍보콘텐츠, 등록 | general-purpose |
| evaluation-analyst | `.cursor/agents/evaluation-analyst.md` | KPI, 설문, ROI, 교훈 | general-purpose |
...
| 확장 스킬 | 경로 | 대상 에이전트 | 역할 |
|----------|------|-------------|------|
| budget-planning | `.cursor/skills/budget-planning/skill.md` | concept-planner, logistics-manager | 예산 카테고리, 산출 템플릿, 스폰서십 가이드 |
| venue-evaluation | `.cursor/skills/venue-evaluation/skill.md` | logistics-manager | 장소 평가 스코어카드, 답사 체크리스트, 계약 확인 |

...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| document-analyst | `.cursor/agents/document-analyst.md` | 기존 문서/코드 분석, 프로세스 추출 | general-purpose |
| flowchart-designer | `.cursor/agents/flowchart-designer.md` | Mermaid 플로차트, RACI 매트릭스 | general-purpose |
| manual-writer | `.cursor/agents/manual-writer.md` | 단계별 절차서, 체크리스트 | general-purpose |
| faq-builder | `.cursor/agents/faq-builder.md` | FAQ, 트러블슈팅, 에스컬레이션 | general-purpose |
| training-producer | `.cursor/agents/training-producer.md` | 퀴즈, 실습과제, 요약카드 | general-purpose |
...
| 확장 스킬 | 경로 | 대상 에이전트 | 역할 |
|----------|------|-------------|------|
| flowchart-standards | `.cursor/skills/flowchart-standards/skill.md` | flowchart-designer | 플로차트 표기법, 프로세스 패턴, 복잡도 관리 |
| knowledge-base-design | `.cursor/skills/knowledge-base-design/skill.md` | faq-builder, manual-writer | FAQ 설계, 트러블슈팅 진단 트리, 지식 수명주기 |

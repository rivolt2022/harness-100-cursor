...
| 에이전트 | 파일 | 역할 | 타입 |
|---------|------|------|------|
| product-planner | `.cursor/agents/product-planner.md` | 시장조사, 경쟁분석, 상품 포지셔닝 | general-purpose |
| detail-page-writer | `.cursor/agents/detail-page-writer.md` | 상세페이지 카피, SEO, 전환 최적화 | general-purpose |
| pricing-strategist | `.cursor/agents/pricing-strategist.md` | 원가분석, 가격설계, 프로모션 | general-purpose |
| marketing-manager | `.cursor/agents/marketing-manager.md` | 런칭 캠페인, 채널전략, 광고카피 | general-purpose |
| cs-architect | `.cursor/agents/cs-architect.md` | FAQ, 응대매뉴얼, 반품정책, VOC | general-purpose |
...
| 확장 스킬 | 경로 | 대상 에이전트 | 역할 |
|----------|------|-------------|------|
| conversion-optimization | `.cursor/skills/conversion-optimization/skill.md` | detail-page-writer, pricing-strategist | 구매 심리, 전환 구조, CTA, 가격 심리 |
| product-copy-formulas | `.cursor/skills/product-copy-formulas/skill.md` | detail-page-writer, marketing-manager | PAS/FAB/AIDA 카피 공식, 채널별 가이드 |
